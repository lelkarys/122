...
│➯ 💟*/отключить скрытый*
│➯ 💟*/включить ограничить*
│➯ 💟*/отключить ограничить*
│➯ 💟*/включить антиссылка*
│➯ 💟*/отключить антиссылка*
│➯ 💟*/включить антиссылка2*
│➯ 💟*/отключить антиссылка2*
│➯ 💟*/включить обнаружить*
│➯ 💟*/отключить обнаружить*
│➯ 💟*/включить обнаружить2*
│➯ 💟*/отключить обнаружить2*
│➯ 💟*/включить автостикер*
│➯ 💟*/отключить автостикер*
│➯ 💟*/включить aнтиспам*
│➯ 💟*/отключить интиспам*
│➯ 💟*/включить антивирус*
│➯ 💟*/отключить антивирус*
...
│➯ 💟*/отключить антииндус*
│➯ 💟*/включить антииндус2*
│➯ 💟*/отключить антииндус2*
│➯ 💟*/включить толькоадмин*
│➯ 💟*/отключить толькоадмин*
︎╰───────────────╯`.trim()
if (m.isGroup) {
