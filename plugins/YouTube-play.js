...
await m.reply(`*Если ваш заказ не отправлен, вы можете использовать команды* \n*/аудио название трека*\n*/видео название ролика*`)
...
➯➤📆 *Дата:* ${yt_play[0].ago}
➯➤⌚ *Длительность:* ${secondString(yt_play[0].duration.seconds)}
...
await conn.sendMessage(m.chat, { video: { url: mediaa.result }, fileName: `error.mp4`, caption: `⫷᭄©Ванилька✍`, thumbnail: mediaa.thumb, mimetype: 'video/mp4' }, { quoted: m })     
} catch {  
try {
